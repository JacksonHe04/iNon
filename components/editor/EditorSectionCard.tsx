        ...
        {onSave && (
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-gradient-to-r from-teal-500 to-emerald-500 hover:from-teal-600 hover:to-emerald-600 text-white font-medium text-xs shadow-md disabled:opacity-50 transition-all active:scale-95"
            >
              {saveStatus === 'saving' ? (
                <>
