...
export default function HiphopBlock({
  ...
  return (
    <GlassCard className="p-5 space-y-5 hover:border-orange-400/40 transition-all duration-300">
          ...
          <div className={`grid gap-3 ${colSpan === 2 ? 'grid-cols-3' : 'grid-cols-2'}`}>
            {albums.map((album, idx) => (
              <div
                ...
                className="p-3 rounded-xl bg-white/40 dark:bg-gray-800/40 border border-white/20 hover:border-orange-400/40 transition cursor-pointer flex flex-col justify-between"
              >
                <div>
          ...
          <div className="space-y-3.5 text-gray-700 dark:text-gray-200">
            ...
            {selectedDetail.link && selectedDetail.link.trim() !== '' && (
              <a
                ...
                className="inline-flex items-center gap-1 text-sm font-semibold text-orange-600 dark:text-orange-400 hover:underline mt-2"
              >
                <span>听歌/了解更多</span>
