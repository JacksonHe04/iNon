...
export const BLOCK_REGISTRY: Record<BlockType, BlockDisplayConfig> = {
  ...
  music: { type: 'music', title: '音乐', icon: Music },
  movies: { type: 'movies', title: '影视', icon: Film },
  books: { type: 'books', title: '书单', icon: BookOpen },
  games: { type: 'games', title: '游戏', icon: Gamepad2 },
  ...
  products: { type: 'products', title: '爱用产品', icon: Smartphone },
  creation: { type: 'creation', title: '个人创作', icon: Palette },
  hiphop: { type: 'hiphop', title: '嘻哈', icon: Mic2 },
  events: { type: 'events', title: 'Live 与活动', icon: CalendarDays },
  tags: { type: 'tags', title: '同频标签', icon: Tag },
